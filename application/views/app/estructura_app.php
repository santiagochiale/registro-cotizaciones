...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/plugins/daterangepicker/daterangepicker.css">
  <!--Favicon-->
  <link rel="shortcut icon" href="<?php echo base_url(); ?>/UB_Icon.ico" type="image/x-icon">
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          ...
          <?php if (!empty($this->session->username)) : ?>
        <li class="nav-item">
          <a class= "nav-link" href="<?php echo base_url() ?>index.php/Auth/logout" id="logout">Salir</a>
        </li>
          <?php endif; ?>
      </ul>
    </nav>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        ...
        <!--<img src="<?php echo base_url(); ?>/assets/logos/logo_color.bmp" alt="ub logo" class="brand-image img-circle elevation-3" style="opacity: .8">-->
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="info">
            <a href="#" class="d-block">Usuario:<?php echo " ".$this->session->userdata('username') ?></a>
          </div>
        </div>
