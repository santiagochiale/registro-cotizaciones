<!-- <?php
// if (isset($data_dashboard)){
// echo '<pre>'; print_r($data_dashboard); echo '</pre>'; exit();
// }
?> -->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <span class="card-title">Buscador de operaciones-Si desea traer todas las operaciones solo oprima "Buscar" en la parte inferior</span>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
